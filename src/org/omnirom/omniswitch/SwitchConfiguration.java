...
public class SwitchConfiguration {
    ...
    public void updatePrefs(SharedPreferences prefs, String key) {
        ...
        Utils.buttonStringToArry(prefs.getString(SettingsActivity.PREF_BUTTONS,
                SettingsActivity.PREF_BUTTON_DEFAULT), mButtons);
        ...
        mSpeedSwitchButtons = Utils.getDefaultSpeedSwitchButtons();
        Utils.buttonStringToArry(prefs.getString(SettingsActivity.PREF_SPEED_SWITCHER_BUTTON,
                SettingsActivity.PREF_SPEED_SWITCHER_BUTTON_DEFAULT), mSpeedSwitchButtons);
